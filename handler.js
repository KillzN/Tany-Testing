...
global.dfail = (type, m, conn) => {
    const msg = {
        rowner: `🚩 Hola, este comando solo puede ser utilizado por *TANYBOT*.`,
        owner: `👤 Usuario, Este Comando Solo Puede Ser Utilizado Por *TANYBOT*.`,
        mods: `🤚🏻 Hola, este comando solo puede ser utilizado por *TANYBOT*.`,
