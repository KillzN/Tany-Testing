...
handler.all = async function (m) {
    ...
    //Emojis determinado de TANYBOT Bot
    global.emoji = '🍁'
    global.emoji2 = '⭐'
    global.emoji3 = '✨️'
    global.emoji4 = '😴'
    ...
    // global.estilo = { key: {  fromMe: false, participant: `0@s.whatsapp.net`, ...(false ? { remoteJid: "51917518909-1625305606@g.us" } : {}) }, message: { orderMessage: { itemCount : -999999, status: 1, surface : 1, message: `${packname}`, orderTitle: 'Bang', thumbnail: icons, sellerJid: '0@s.whatsapp.net'}}}
    ...
    global.icono = [
        'https://i.ibb.co/WpqWd0xv/Tany.jpg',
        'https://i.ibb.co/WpqWd0xv/Tany.jpg',
        'https://i.ibb.co/WpqWd0xv/Tany.jpg'
    ].getRandom()
